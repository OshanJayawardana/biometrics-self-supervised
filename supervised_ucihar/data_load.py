...
def base_loader(mthd, window_size=128, domain=1):
    ...
    for atrbt in ['body_acc','total_acc','body_gyro']:
        for axs in ['x','y','z']:
            ...
            path=r"/share/home/ojay4477/contrastive_ucihar/UCI HAR/uci-human-activity-recognition/original/UCI HAR Dataset/"+mthd+"/Inertial Signals"
    ...
    if domain:
        file=open(r"/share/home/ojay4477/contrastive_ucihar/UCI HAR/uci-human-activity-recognition/original/UCI HAR Dataset/"+mthd+"/Inertial Signals/y_"+mthd+".txt",'r') #for activity recognition
    else:
        file=open(r"/share/home/ojay4477/contrastive_ucihar/UCI HAR/uci-human-activity-recognition/original/UCI HAR Dataset/"+mthd+"/Inertial Signals/y_"+mthd+"_sub.txt",'r') #for user authentication
