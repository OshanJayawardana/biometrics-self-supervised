...
for i in range(10):
    ...
    SEED = 34
    ssl_ds_one = tf.data.Dataset.from_tensor_slices(custom_augment(x_train))
    ...
    def get_encoder():
        ...
        #x = layers.Dropout(0.1)(x)
        x = layers.Conv1D(filters=1024, kernel_size=3, activation='relu',kernel_regularizer=regularizers.l2(0.0001))(inputs)#64 #10
        x = layers.Dropout(0.1)(x)
