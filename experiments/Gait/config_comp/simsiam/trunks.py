...
def trunk_1(frame_size, ft_len): # 16
    con=1
    ks=3
...
def trunk_2(frame_size, ft_len): # 16, 32
    con=1
    ks=3
    input_ = Input(shape=(frame_size, ft_len), name='input_')
    x = Conv1D(filters=16*con,kernel_size=ks,strides=1, padding='same')(input_) 
...
def trunk_3(frame_size, ft_len): # 48, 96
    con=3
    ks=3
    input_ = Input(shape=(frame_size, ft_len), name='input_')
    x = Conv1D(filters=16*con,kernel_size=ks,strides=1, padding='same')(input_) 
...
def trunk_4(frame_size, ft_len): # 64, 128
    con=4
    ks=3
    input_ = Input(shape=(frame_size, ft_len), name='input_')
    x = Conv1D(filters=16*con,kernel_size=ks,strides=1, padding='same')(input_) 
...
def trunk_5(frame_size, ft_len): # 16, 32, 64
    con=1
    ks=3
    input_ = Input(shape=(frame_size, ft_len), name='input_')
    x = Conv1D(filters=16*con,kernel_size=ks,strides=1, padding='same')(input_) 
...
def trunk_6(frame_size, ft_len): # 48, 96, 192
    con=3
    ks=3
    input_ = Input(shape=(frame_size, ft_len), name='input_')
    x = Conv1D(filters=16*con,kernel_size=ks,strides=1, padding='same')(input_) 
